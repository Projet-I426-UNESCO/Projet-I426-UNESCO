...
router.get('/profile/edit', [ProfileController, 'edit']).as('profile.editview').use(middleware.auth())
router.post('/profile/edit', [ProfileController, 'update']).as('profile.edit').use(middleware.auth())
